<?php
/**
 * Wedge_Sniffs_Commenting_WhitespaceAfterSingleLineCommentSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @package   Wedge_Standard
 */
class Wedge_Sniffs_Commenting_WhitespaceAfterSingleLineCommentSniff implements PHP_CodeSniffer_Sniff
{
	/**

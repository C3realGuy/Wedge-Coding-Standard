<?php
/**
 * Wedge_Sniffs_Functions_OpeningAndClosingFunctionBracesSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link	  http://pear.php.net/package/PHP_CodeSniffer
 */
class Wedge_Sniffs_Functions_OpeningAndClosingFunctionBracesSniff implements PHP_CodeSniffer_Sniff
{
	/**
	 ...
	 * @return void
	 */
	public $checkSingleLineFunctions = false;
	...
	public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
	{
		...
		file_put_contents('/tmp/test', var_export($tokens, true));
		...
		$braceLineClose = $tokens[$closingBrace]['line'];
		$lineDifference = ($braceLine - $functionLine);

		$isSingeLineFunction = $braceLine === $braceLineClose && $braceLine === $functionLine;
		// var_export([$braceLine, $braceLineClose, $functionLine]);
		if ((bool) $this->checkSingleLineFunctions === false && $isSingeLineFunction === true)
			return;
		if ($lineDifference === 0) {
